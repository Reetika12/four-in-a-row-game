            ...
            <div className="ParentClass">
                ...
                <div style={{display:'flex',flexDirection:'column',padding:'30px 30px'}}>
                    ...
                    <RadioGroup aria-label="gender" name="gender1" value={this.state.selectedValue} onChange={this.handleChangeForGame}>
                        <FormControlLabel className="singleBox" style={{marginLeft:'0px',marginRight:'0px'}} value="games2" control={<CustomRadio />} label="2 Games" />
                        <FormControlLabel className="singleBox" style={{ marginLeft: '0px', marginRight: '0px' }} value="games3" control={<CustomRadio />} label="3 Games" />
                        <FormControlLabel className="singleBox" style={{ marginLeft: '0px', marginRight: '0px' }}  value="games5" control={<CustomRadio />} label="5 Games" />
                        <FormControlLabel className="singleBox" style={{ marginLeft: '0px', marginRight: '0px' }} value="games10" control={<CustomRadio />} label="10 Games" />
                    </RadioGroup>
